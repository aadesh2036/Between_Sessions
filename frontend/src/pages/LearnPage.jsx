      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {(data.books || []).map((book) => {
                ...
                return (
                  <div
                    key={book.id}
                    className="bg-brand-paper border border-brand-border/70 rounded-3xl p-6 sm:p-7 shadow-card-lift flex flex-col justify-between space-y-4"
                  >
                        ...
                        {(book.chapters || []).map((ch, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className="w-full text-left p-2.5 rounded-xl hover:bg-brand-canvas border border-transparent hover:border-brand-border/60 transition-colors flex items-start gap-2.5 text-xs group"
                            >
                              <span
        ...
        {activeTab === 'guides' && (
          <div className="space-y-5 animate-fade-in">
            ...
            <div className="p-6 sm:p-7 rounded-3xl bg-brand-softerTeal border border-brand-teal/30 shadow-card-lift space-y-3">
              ...
              <p className="text-xs sm:text-sm text-brand-ink/80 leading-relaxed max-w-3xl">
          ...
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {(data.resources || []).map((res) => (
                <div
                  key={res.id}
                  className="bg-brand-paper border border-brand-border/70 rounded-2xl p-6 shadow-card-lift flex flex-col justify-between space-y-3.5"
                >
