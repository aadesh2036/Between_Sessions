...
export default function StackedFeatureCards() {
  ...
  return (
    <section ref={containerRef} id="architecture" className="relative min-h-[420vh] py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        {/* Compact Stepper & Layer Controller Bar */}
        ...
        <div className="card-stack-stage relative w-full h-[580px] lg:h-[600px]">
